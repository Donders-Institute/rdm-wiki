...
We created this wiki to teach you everything you need to know about :bdg-success:`RDM` within the :bdg-danger:`DCCN`. 
...
**This wiki contains tutorials and practical guidelines which will teach you how to navigate the** :bdg-success:`RDM` **infrastructure in the** :bdg-danger:`DCCN` **so that you can run your project efficiently and in compliance with relevant policies.**

Other Resources
===========

This wiki is intended to be very practical, so we will most ignore the theoretical side of :bdg-success:`RDM`. 
Therefore, throughout the wiki we will link you to more resources which talk about these; both at the `DCCN level`_ and the `Radboud University level`_.
...
.. dropdown:: Take Home Messages
    ...
    * This Wiki will teach you how to best do :bdg-success:`RDM` at the :bdg-danger:`DCCN`
