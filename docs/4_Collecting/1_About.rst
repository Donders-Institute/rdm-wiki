...
:bdg-secondary:`Collecting Data` is the next stage in the Research Life Cycle. 
...
what the governing :bdg-info:`procedures` are, how you can most effectively make use of our :bdg-dark:`tools` and :bdg-primary:`infrastructure`, and which :bdg-warning:`workflows` you should be aware of.
