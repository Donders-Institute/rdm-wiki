...
Knowing where data can and should be stored, as well as when it should be stored in certain locations is crucial in generating a plan of how you will manage data.
